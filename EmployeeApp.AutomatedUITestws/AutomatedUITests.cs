...
namespace EmployeeApp.AutomatedUITestws
{
    public class AutomatedUITests: IDisposable
    {
        ...
        public AutomatedUITests()
        {
            ...
            _driver = new ChromeDriver(@"D:\L_SCHIAVON_DOCUMENTS\LAVORO\NOGIT\IntegrationTestsExampleGit\testing-aspnetcore-mvc\StartingProject\EmployeesApp\EmployeeApp.AutomatedUITestws\LS_ChromeDriver");
